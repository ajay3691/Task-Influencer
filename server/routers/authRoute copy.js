...
// Define middleware functions (make sure to define these functions)
const middleware = (req, resp, next) => {
    // Add your middleware logic here for admin access
    // For example, check if the user is an admin based on the token
    // ...

    next();
};

const middlewareU = (req, resp, next) => {
    // Add your middleware logic here for user access
    // For example, check if the user is a regular user based on the token
    // ...
